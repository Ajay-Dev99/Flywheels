const { AdminLogin, adminHome, addcar, listUsers, addCategory, ListCategories, viewVehicleDetails, editCar, deleteVehicle, addHub, blockUser, getHubs, ViewHub, EditHub, listBookings, getOrderDetails, changeOrderStatus, AdminDashBoard, FilterOrders } = require("../Controllers/AdminControllers");
...
router.post("/filterorders", adminAuth, FilterOrders)
